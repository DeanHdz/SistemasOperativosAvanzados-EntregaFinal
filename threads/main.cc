...
else if (!strcmp(*argv, "-help")) {	// Mostrar en terminal la ayuda de un comando especifico
            ASSERT(argc > 1);
	    fileSystem->Ayuda(*(argv + 1)); //Para funcionar el syntaxis debe ser: ./nachos -help man (man siendo -man de Manual, es importante no incluir el ' - ')
	}
else if (!strcmp(*argv, "-inf")) {	// Visualizar en terminal informacion del equipo/Materia/practica
